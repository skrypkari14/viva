...
const Statistics = () => {
  ...
  return (
    <div className="grid grid-cols-10 gap-5">
      <div className="grid md:grid-cols-4 lg:grid-cols-8 gap-5 col-span-10">
      ...
      <div className="py-5 bg-white rounded-[20px] col-span-10 lg:col-span-7 drop-shadow-xl">
      ...
      <div className="py-5 bg-white rounded-[20px] col-span-10 lg:col-span-3 drop-shadow-xl">
      ...
      <div className="bg-white rounded-[20px] py-5 col-span-10 lg:col-span-4 2xl:col-span-4 drop-shadow-xl">
      ...
      <div className="bg-white rounded-[20px] py-5 xl:col-span-6 col-span-10 min-h-[380px] drop-shadow-xl">
        <div className="mx-5 h-full pb-5">
          <h3 className="text-xl text-purple-900 font-semibold">Все услуги</h3>
          <TableComponent data={data} />
        </div>
      </div>
      <div className="bg-white rounded-[20px] py-5 2xl:col-span-7 xl:col-span-5 col-span-10 drop-shadow-xl">
      ...
      <div className="bg-white rounded-[20px] py-5 2xl:col-span-3 xl:row-end-5 xl:col-span-5 lg:row-end-4 lg:col-span-6 col-span-10 drop-shadow-xl">

  ...
  return (
    <div className="">
      <div className="grid grid-cols-4 gap-5">
        <div className="py-4 bg-white rounded-[20px] flex items-center pl-5 gap-3 drop-shadow-xl	">
      ...
      <div className="mt-5 grid grid-cols-3 gap-5">
        <div className="py-5 bg-white rounded-[20px] col-span-2 drop-shadow-xl">
        ...
        <div className="py-5 bg-white rounded-[20px] drop-shadow-xl">
          <div className="ml-4 relative mr-4">
            ...
            <h3 className="font-bold text-4xl text-purple-900 mt-2 mb-10">
              220
            </h3>
      ...
      <div className="grid grid-cols-5 gap-5 mt-5">
        <div className="bg-white rounded-[20px] py-5 col-span-2 drop-shadow-xl">
        ...
        <div className="bg-white rounded-[20px] py-5 col-span-3 drop-shadow-xl">
          <div className="mx-5 h-full pb-5">
            <h3 className="text-xl text-purple-900 font-semibold">
              Все услуги
            </h3>
      ...
      <div className="grid mt-5 gap-5 lg:grid-cols-2 2xl:grid-cols-3">
        <div className="bg-white rounded-[20px] py-5 2xl:col-span-2 drop-shadow-xl">
        ...
        <div className="bg-white rounded-[20px] py-5 drop-shadow-xl">
